...
// BluetoothCommunicator removed — WebRTC is used for call transport.
...
public class Global extends Application implements DefaultLifecycleObserver {
    ...
    // bluetoothCommunicator removed — WebRTC handles call transport
    ...
    /** No-op kept for source compat — Bluetooth removed. */
    public void initializeBluetoothCommunicator() { /* no-op */ }

    /** Always null — BluetoothCommunicator removed. */
    @Nullable
    ...
    /** No-op kept for source compat — Bluetooth removed. */
    public void resetBluetoothCommunicator() { /* no-op */ }
    ...
    public void setName(String savedName) {
        ...
        editor.apply();
        // BluetoothCommunicator removed — no need to update name there
    }
